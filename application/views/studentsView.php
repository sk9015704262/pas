                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter  name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter  father's name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter mother's name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter DOB">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter roll. no">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter full address">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter contact number">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter your branch">
                                ...
                                <div class="card-block">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Enter your school name"></div>
                                                <div class="col-md-3">
                                               
                                                
                                                <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Percentage">   
                                            </div>
                                            <div class="col-md-3">
                                            <input type="text" id="text-input" name="text-input" class="form-control" placeholder="Year of passing">   
                                            </div>
                                        </div>
